...
```{r summary_countries, echo=FALSE, fig.height=3, fig.width=11, message=FALSE, warning=FALSE}
...
x <- rbind(
  ...
  extract_info_maft_proportions("Overall", inc1),
  c(NA),
  c("by Country", rep(NA, 8)),
  extract_info_maft_proportions("Argentina", arg1),
  extract_info_maft_proportions("Australia", aus1),
  extract_info_maft_proportions("Canada", can1),
  extract_info_maft_proportions("Germany", ger1),
  extract_info_maft_proportions("Italy", ita1),
  extract_info_maft_proportions("Spain", spa1),
  extract_info_maft_proportions("USA", inc15),
  c(NA))
...
prevalence <- cbind(
  ...
  c("Details", 
    NA, "Supp Fig #1", NA, 
    NA, "Supp Fig #18", "Supp Fig #19", "Supp Fig #20", "Supp Fig #21", "Supp Fig #22", "Supp Fig #23", "Supp Fig #12", NA))
...
<details><summary>Click to show</summary>
  ...
  + <details><summary> Suppl. Figure 1: (FT) Frequency of Overall Incidental diagnosis in patients with TC </summary>
  <p>
```{r ft_incidental_overallV2, echo=FALSE, fig.height=5, fig.width=12, message=FALSE, warning=FALSE} 
...
```
  ...
  + <details><summary> Suppl. Figure 18: (FT) Frequency of Incidental diagnosis in all patients with TC from Argentina</summary>
  <p>
```{r ft_incidental_argentina, echo=FALSE, fig.height=2, fig.width=11, message=FALSE, warning=FALSE} 

targ1 <- table_singleproportion_ft(xi = arg1$pre$x, 
                                    ni = arg1$pre$n,
                                    analysis = arg1)

plot_single_proportion_ft(words = targ1$b,
                          numbers = targ1$c,
                          overall_box = 1)
...
```
  ...
  + <details><summary> Suppl. Figure 19: (FT) Frequency of Incidental diagnosis in all patients with TC from Autralia</summary>
  <p>
```{r ft_incidental_australia, echo=FALSE, fig.height=2, fig.width=11, message=FALSE, warning=FALSE} 

taus1 <- table_singleproportion_ft(xi = aus1$pre$x, 
                                    ni = aus1$pre$n,
                                    analysis = aus1)

plot_single_proportion_ft(words = taus1$b,
                          numbers = taus1$c,
                          overall_box = 1)
...
```
  ...
  + <details><summary> Suppl. Figure 20: (FT) Frequency of Incidental diagnosis in all patients with TC from Canada</summary>
  <p>
```{r ft_incidental_Canada, echo=FALSE, fig.height=2, fig.width=11, message=FALSE, warning=FALSE} 

tcan1 <- table_singleproportion_ft(xi = can1$pre$x, 
                                    ni = can1$pre$n,
                                    analysis = can1)

plot_single_proportion_ft(words = tcan1$b,
                          numbers = tcan1$c,
                          overall_box = 1)
...
```
  ...
  + <details><summary> Suppl. Figure 21: (FT) Frequency of Incidental diagnosis in all patients with TC from Germany</summary>
  <p>
```{r ft_incidental_Germany, echo=FALSE, fig.height=2, fig.width=11, message=FALSE, warning=FALSE} 

tger1 <- table_singleproportion_ft(xi = ger1$pre$x, 
                                    ni = ger1$pre$n,
                                    analysis = ger1)

plot_single_proportion_ft(words = tger1$b,
                          numbers = tger1$c,
                          overall_box = 1)
...
```
  ...
  + <details><summary> Suppl. Figure 22: (FT) Frequency of Incidental diagnosis in all patients with TC from Italy</summary>
  <p>
```{r ft_incidental_italy, echo=FALSE, fig.height=2.5, fig.width=12, message=FALSE, warning=FALSE} 

tita1 <- tables_proportion_ft(xi = ita1$pre$x, 
                              ni = ita1$pre$n,
                              analysis = ita1)

plot_individual_proportion_ft(words = tita1$b,
                              numbers = tita1$c,
                              sizebox = 0.03,
                              box_ma_results = ita1$ma,
                              overall_box = 1)
```
  </p>
  </details>
  ...
  + <details><summary> Suppl. Figure 23: (FT) Frequency of Incidental diagnosis in all patients with TC from Spain</summary>
  <p>
```{r ft_incidental_spain, echo=FALSE, fig.height=2, fig.width=11, message=FALSE, warning=FALSE} 

tspa1 <- table_singleproportion_ft(xi = spa1$pre$x, 
                                    ni = spa1$pre$n,
                                    analysis = spa1)

plot_single_proportion_ft(words = tspa1$b,
                          numbers = tspa1$c,
                          overall_box = 1)
...
```
  ...
  + <details><summary> Suppl. Figure 12: (FT) Frequency of Incidental diagnosis in patients with TC from the USA </summary>
  <p>
```{r ft_imaging_USAV2, echo=FALSE, fig.height=3, fig.width=12, message=FALSE, warning=FALSE}
tinc15 <- tables_proportion_ft(xi = inc15$pre$x, 
                              ni = inc15$pre$n,
                              analysis = inc15)
...
prevalence <- cbind(
  ...
  c("Details", 
    NA, "Supp Fig #2", NA, 
    NA, NA, "Supp Fig #24", "Supp Fig #25", 
    NA, "Supp Fig #26", "Supp Fig #27",
    NA, "Supp Fig #28", "Supp Fig #29", 
    NA, "Supp Fig #30", "Supp Fig #31", 
    NA, "Supp Fig #32", "Supp Fig #33",
    NA, NA, "Supp Fig #7", NA, 
    NA, NA, "Supp Fig #34", "Supp Fig #35", 
    NA, "Supp Fig #36", "Supp Fig #37", 
    NA, "Supp Fig #38", "Supp Fig #39",
    NA, "Supp Fig #40", "Supp Fig #41", 
    NA, "Supp Fig #42", "Supp Fig #43",
    NA))
...
```
  ...
  + <details><summary> Suppl. Figure 24: (FT) Frequency of Incidental Imaging diagnosis in Male patients with TC </summary>
<p>
...
```
  ...
  + <details><summary> Suppl. Figure 25: (FT) Frequency of Incidental Imaging diagnosis in Female patients with TC </summary>
  <p>
...
```
  ...
  + <details><summary> Suppl. Figure 26: (FT) Frequency of Incidental Imaging diagnosis in patients aged 45 years and older with TC </summary>
  <p>
...
```
  ...
  + <details><summary> Suppl. Figure 27: (FT) Frequency of Incidental Imaging diagnosis in patients aged 45 years and younger with TC </summary>
  <p>
...
```
  ...
  + <details><summary> Suppl. Figure 28: (FT) Frequency of Incidental Imaging diagnosis in patients with TC and  tumor size >10mm </summary>
  <p>
...
```
  ...
  + <details><summary> Suppl. Figure 29: (FT) Frequency of Incidental Imaging diagnosis in patients with TC and tumor size <10mm </summary>
  <p>
...
```
  ...
  + <details><summary> Suppl. Figure 30: (FT) Frequency of Incidental Imaging diagnosis in patients with TC from the USA </summary>
  <p>
...
```
  ...
  + <details><summary> Suppl. Figure 31: (FT) Frequency of Incidental Imaging diagnosis in patients with TC from a non-USA country </summary>
  <p>
...
```
  ...
  + <details><summary> Suppl. Figure 32: (FT) Frequency of Incidental Imaging diagnosis in patients with TC from population based studies </summary>
  <p>
...
```
  ...
  + <details><summary> Suppl. Figure 33: (FT) Frequency of Incidental Imaging diagnosis in patients with TC from non-population-based studies </summary>
  <p>
...
```
  ...
  + <details><summary> Suppl. Figure 34: (FT) Frequency of Incidental Histology diagnosis in Male patients with TC </summary>
  <p>
...
```
  ...
  + <details><summary> Suppl. Figure 35: (FT) Frequency of Incidental Histology diagnosis in Female patients with TC </summary>
  <p>
...
```
  ...
  + <details><summary> Suppl. Figure 36: (FT) Frequency of Incidental Histology diagnosis in patients aged 45 years and older with TC </summary>
  <p>
...
```
  ...
  + <details><summary> Suppl. Figure 37: (FT) Frequency of Incidental Histology diagnosis in patients aged 45 years and younger with TC </summary>
  <p>
...
```
  ...
  + <details><summary> Suppl. Figure 38: (FT) Frequency of Incidental Histology diagnosis in patients with TC and  tumor size >10mm </summary>
  <p>
...
```
  ...
  + <details><summary> Suppl. Figure 39: (FT) Frequency of Incidental Histology diagnosis in patients with TC and tumor size <10mm </summary>
  <p>
...
```
  ...
  + <details><summary> Suppl. Figure 40: (FT) Frequency of Incidental Histology diagnosis in patients with TC from the USA </summary>
  <p>
...
```
  ...
  + <details><summary> Suppl. Figure 41: (FT) Frequency of Incidental Histology diagnosis in patients with TC from a non-USA country </summary>
  <p>
...
```
  ...
  + <details><summary> Suppl. Figure 42: (FT) Frequency of Incidental Histology diagnosis in patients with TC from population based studies </summary>
  <p>
...
```
  ...
  + <details><summary> Suppl. Figure 43: (FT) Frequency of Incidental Histology diagnosis in patients with TC from non-population-based studies </summary>
  <p>
...
<details><summary> Suppl. Figure 44: (GLMM) Frequency of Incidental diagnosis in patients with TC </summary>
<p>
...
<details><summary> Suppl. Figure 45: (GLMM) Frequency of Incidental diagnosis in Male patients with TC </summary>
<p>
...
<details><summary> Suppl. Figure 46: (GLMM) Frequency of Incidental diagnosis in Female patients with TC </summary>
<p>
...
<details><summary> Suppl. Figure 47: (GLMM) Frequency of Incidental diagnosis in patients with TC and  tumor size >10mm </summary>
<p>
...
<details><summary> Suppl. Figure 48: (GLMM) Frequency of Incidental diagnosis in patients with TC and tumor size <10mm </summary>
<p>
...
<details><summary> Suppl. Figure 49: (GLMM) Frequency of Incidental diagnosis in patients with TC from the USA </summary>
<p>
...
<details><summary> Suppl. Figure 50: (GLMM) Frequency of Incidental diagnosis in patients with TC from a non-USA country </summary>
<p>
...
<details><summary> Suppl. Figure 51: (GLMM) Frequency of Incidental diagnosis in patients with TC from population based studies </summary>
<p>
...
<details><summary> Suppl. Figure 52: (GLMM) Frequency of Incidental diagnosis in patients with TC from non-population-based studies </summary>
<p>
...
<details><summary> Suppl. Figure 53: (GLMM) Frequency of Incidental diagnosis in patients with TC </summary>
<p>
...
<details><summary> Suppl. Figure 54: (GLMM) Frequency of Incidental imaging diagnosis in Male patients with TC </summary>
<p>
...
<details><summary> Suppl. Figure 55: (GLMM) Frequency of Incidental imaging diagnosis in Female patients with TC </summary>
<p>
...
<details><summary> Suppl. Figure 56: (GLMM) Frequency of Incidental imaging diagnosis in patients with TC and  tumor size >10mm </summary>
<p>
...
<details><summary> Suppl. Figure 57: (GLMM) Frequency of Incidental imaging diagnosis in patients with TC and tumor size <10mm </summary>
<p>
...
<details><summary> Suppl. Figure 58: (GLMM) Frequency of Incidental imaging diagnosis in patients with TC from the USA </summary>
<p>
...
<details><summary> Suppl. Figure 59: (GLMM) Frequency of Incidental imaging diagnosis in patients with TC from a non-USA country </summary>
<p>
...
<details><summary> Suppl. Figure 60: (GLMM) Frequency of Incidental imaging diagnosis in patients with TC from population based studies </summary>
<p>
...
<details><summary> Suppl. Figure 61: (GLMM) Frequency of Incidental imaging diagnosis in patients with TC from non-population-based studies </summary>
<p>
...
<details><summary> Suppl. Figure 62: (GLMM) Frequency of Incidental Ultrasound diagnosis in patients with TC </summary>
<p>
...
<details><summary> Suppl. Figure 63: (GLMM) Frequency of Incidental Computed Tomography Scan diagnosis in patients with TC </summary>
<p>
...
<details><summary> Suppl. Figure 64: (GLMM) Frequency of Incidental Positron Emission Tomography diagnosis in patients with TC </summary>
<p>
...
<details><summary> Suppl. Figure 65: (GLMM) Frequency of Incidental Magnetic Resonance Imaging diagnosis in patients with TC </summary>
<p>
...
<details><summary> Suppl. Figure 66: (GLMM) Frequency of Incidental histology diagnosis in patients with TC </summary>
<p>
...
<details><summary> Suppl. Figure 67: (GLMM) Frequency of Incidental histology diagnosis in Male patients with TC </summary>
<p>
...
<details><summary> Suppl. Figure 68: (GLMM) Frequency of Incidental Histology diagnosis in Female patients with TC </summary>
<p>
...
<details><summary> Suppl. Figure 69: (GLMM) Frequency of Incidental Histology diagnosis in patients with TC and  tumor size >10mm </summary>
<p>
...
<details><summary> Suppl. Figure 70: (GLMM) Frequency of Incidental Histology diagnosis in patients with TC and tumor size <10mm </summary>
<p>
...
<details><summary> Suppl. Figure 71: (GLMM) Frequency of Incidental Histology diagnosis in patients with TC from the USA </summary>
<p>
...
<details><summary> Suppl. Figure 72: (GLMM) Frequency of Incidental Histology diagnosis in patients with TC from a non-USA country </summary>
<p>
...
<details><summary> Suppl. Figure 73: (GLMM) Frequency of Incidental Histology diagnosis in patients with TC from population based studies </summary>
<p>
...
<details><summary> Suppl. Figure 74: (GLMM) Frequency of Incidental Histology diagnosis in patients with TC from non-population-based studies </summary>
<p>
...
<details><summary> Suppl. Figure 75: (FT) Frequency of Incidental diagnosis in patients with TC </summary>
  <p>
...
<details><summary> Suppl. Figure 76: (GLMM) Frequency of Incidental Histology diagnosis in patients with TC from non-population-based studies </summary>
<p>
